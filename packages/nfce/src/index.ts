...
export { completeKeyConsult, fetchReceipt, startKeyConsult } from "./fetch";
export type { FetchOptions, KeyConsultChallenge, KeyConsultSession } from "./fetch";
export { parseReceipt } from "./parse";
export { SEFAZ_PORTALS, validateAccessKey, validateNfceUrl } from "./sefaz";
